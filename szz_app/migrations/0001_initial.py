    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questions', models.ManyToManyField(related_name='questionnaires', to='szz_app.question')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('questionnaire', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='szz_app.questionnaire')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='szz_app.result')),
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='szz_app.topic')),
            ],
        ),
        migrations.CreateModel(
            name='TakePoint',
