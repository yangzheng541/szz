"""
Django settings for szz project.
...
SECRET_KEY = 'django-insecure-_gaclv1l4g!-e+-=xjc)w)hexnz4xsk=pr5*!y*q_k5-4qsa^l'
...
WSGI_APPLICATION = 'szz.wsgi.application'
